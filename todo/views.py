...
from django.contrib.auth.decorators import login_required      #only login user can change list of todos
...
@login_required                    #need this, to logout out if you're logged in the first place
...
def completedtodos(request):
    todos = Todo.objects.filter(user=request.user, datecompleted__isnull=False).order_by('-datecompleted')  #order by recent date first  
